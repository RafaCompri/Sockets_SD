...
def Primo1(x):                   # função criada apenas para receber um numero primo
    if(sympy.isprime(x)):
        return x
    x+=1
    return Primo1(x)
...
def Primo2(x):                  # função criada apenas para receber um numero primo
    if(sympy.isprime(x)):
        return x
    x-=1
    return Primo2(x)
            ...
            with conexao:
                ...
                while True:
                    ...
                    for i in range(n):
                        ...
                        n_Primo2 = Primo2(n_Primo2)          # Para este pedaço do código foi pedido ajudar para o Aluno Thiago  =)
